...
STATE_CASES = [
    ...
    ("ok: input box not empty (continue), skipping; cleared an abandoned message", "typing"),
    ("ok: input box not empty (continue), skipping; abandoned message, clear cooling down", "typing"),
    ("ok: input box not empty (draft), skipping; typed after the drop -- theirs", "typing"),
    ("ok: input box not empty (draft), skipping; unchanged for 30s of the 120s grace", "typing"),
    ("ok: input box not empty (draft), skipping; no ticket, so no drop time to measure against", "typing"),
